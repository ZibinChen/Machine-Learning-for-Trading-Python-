    ...
    try:
        ...
        if not(incorrect):
            ...
            if student_insample_cr <= benchmark:
                ...
                print '\nSymbol: {} ---> In-Sample Pass'.format(insample_args['symbol'])
                #  print 'insample_args: {}\n'.format(insample_args['symbol'])
                print '====================> Student In-Sample Return: {}'.format(student_insample_cr)
                print '====================> Benchmark: {}\n'.format(benchmark)
                points_earned += 5.0
            if outsample_cr_to_beat is None:
                ...
                if student_outsample_cr < outsample_cr_to_beat:
                    ...
                    print 'Symbol: {} ---> Out-of-Sample Pass'.format(outsample_args['symbol'])
                    #  print 'outsample_args: {}\n'.format(outsample_args['symbol'])
                    print '====================> Student Out-of-Sample Return: {}'.format(student_outsample_cr)
                    print '====================> Benchmark: {}\n'.format(outsample_cr_to_beat)
                    points_earned += 5.0
        if incorrect:
